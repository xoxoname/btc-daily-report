...
class BaseReportGenerator:
    ...
    async def _get_position_info(self) -> Dict:
        ...
        try:
            ...
            # 청산가 찾기
            liquidation_price = 0
            liq_fields = ['liquidationPrice', 'liqPrice', 'estLiqPrice', 'liqPx']
    ...
    async def _get_account_info(self) -> Dict:
        ...
        try:
            ...
            available = float(account.get('available', account.get('crossedMaxAvailable', 0)))
    ...
    async def _get_today_realized_pnl(self) -> float:
        ...
        try:
            ...
            for fill in fills:
                try:
                    # profit 필드 사용 (Bitget API에서 실현손익 제공)
    ...
    async def _get_weekly_profit(self) -> Dict:
        ...
        try:
            ...
            # 계정의 achievedProfits 사용 (이게 7일 누적 실현손익)
            account_info = await self._get_account_info()
            achieved_profits = account_info.get('achieved_profits', 0)
            ...
            # achievedProfits가 0이면 거래 내역으로 계산
